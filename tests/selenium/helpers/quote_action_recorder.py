"""Runtime evidence recorder for assertion-backed quote Selenium actions."""
...
PATH = ROOT / '.qa-results' / 'selenium-quotes.json'
...
def record_pass(action_id: str, test_id: str, started_at: float, url: str) -> None:
    """Record one action only after its Selenium test has asserted the outcome."""
