...
class ClinicalHospitalizationList(unittest.TestCase):
    ...
    def clear_control(self, control) -> None:
    ...
    def test_ch09_list_exposes_factual_columns_and_blocks_undefined_clinical_filters(self) -> None:
        ...
        self.clear_control(patient_filter)
        ...
        self.clear_control(document_filter)
        ...
        self.assertTrue(self.w.until(EC.visibility_of_element_located((By.CSS_SELECTOR, '[data-action-id="CLINICAL-HOSPITALIZATION-DETAIL"]'))))
        self.clear_control(case_filter)
        ...
        self.assertTrue(self.w.until(EC.visibility_of_element_located((By.CSS_SELECTOR, '[data-action-id="CLINICAL-HOSPITALIZATION-DETAIL"]'))))
        self.clear_control(triage_filter)
        ...
        self.assertTrue(self.w.until(EC.visibility_of_element_located((By.CSS_SELECTOR, '[data-action-id="CLINICAL-HOSPITALIZATION-DETAIL"]'))))
        self.clear_control(company_filter)
        ...
        self.assertTrue(self.w.until(EC.visibility_of_element_located((By.CSS_SELECTOR, '[data-action-id="CLINICAL-HOSPITALIZATION-DETAIL"]'))))
        self.clear_control(clinician_filter)
        ...
        self.assertTrue(self.w.until(EC.visibility_of_element_located((By.CSS_SELECTOR, '[data-action-id="CLINICAL-HOSPITALIZATION-DETAIL"]'))))
        self.clear_control(start_filter)
        ...
        self.assertTrue(self.w.until(EC.visibility_of_element_located((By.CSS_SELECTOR, '[data-action-id="CLINICAL-HOSPITALIZATION-DETAIL"]'))))
        self.clear_control(duration_filter)
