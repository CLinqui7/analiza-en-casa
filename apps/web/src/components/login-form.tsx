  ...
  return (
    <main className="login-shell">
      <section className="login-card">
        ...
        <h1>Analiza en Casa</h1>
        <p>Inicie sesión para acceder a datos sintéticos y acciones según su rol.</p>
        <form className="form-grid" onSubmit={submit}>
          ...
          <button className="button" data-action-id="AUTH-LOGIN" disabled={loading} type="submit">
            Iniciar sesión
          </button>
        </form>
        <button
        ...
        <p className="field-help">
          Modo mock: {mockCredentialHint}. Las demás credenciales sintéticas usan el mismo patrón
          por rol.
        </p>
