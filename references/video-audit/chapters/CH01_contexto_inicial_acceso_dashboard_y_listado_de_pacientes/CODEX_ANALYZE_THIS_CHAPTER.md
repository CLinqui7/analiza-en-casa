# Tarea Codex: auditoría funcional de CH01

## Capítulo

**Contexto inicial, acceso, dashboard y listado de pacientes**  
Rango principal: **0s a 110s**  
Referencias iniciales, inicio de sesión, dashboard y navegación al catálogo de pacientes.
