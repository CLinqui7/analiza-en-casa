...
`CH15-Q004` leaves the authoritative source, profile/category taxonomy, percentages, calculations, pricing effects, write roles, fields, validation, audit, and clinical or financial consequences undefined. Focused Playwright passed 6/6 on isolated port 4182. Selenium source is action-specific and remains `PENDING_RUNTIME` because Python is unavailable. The verified implementation checkpoint is `9919de2d721af24edb9cd2341ea923efecda048d`.
