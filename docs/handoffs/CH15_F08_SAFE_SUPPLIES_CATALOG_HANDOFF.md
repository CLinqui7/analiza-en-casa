...
`CH15-E0068` was opened as well, but CH15-Q004 leaves the safe source, the effects of Facturable/Descuento/Impuesto/Lotes/Giftcard/Transporte en frío, write roles, fields, validation, audit, and clinical rules undefined, so no form is exposed. Playwright passed 12/12; executable Selenium source remains `PENDING_RUNTIME` because Python is unavailable.
