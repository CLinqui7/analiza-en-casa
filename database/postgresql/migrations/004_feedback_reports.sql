CREATE TABLE analiza.feedback_reports (
  ...
  module text NOT NULL CHECK (module IN ('DASHBOARD','PATIENTS','AGENDA','HOSPITALIZATIONS','NURSING','MEDICATIONS','INVENTORY','REPORTS','ACCESS','OTHER')),
  category text NOT NULL CHECK (category IN ('ERROR','QUESTION','IMPROVEMENT')),
